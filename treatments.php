		...
		<div class="container" style="display:flex;flex-direction:column;">
			<div style="display:flex; flex-direction:row;justify-content:space-between;background-color:white">
				<select id="dropdown" style="margin-bottom:8vh;width:40%;min-width:fit-content"  onchange="window.open(this.value,'_self');">
                    <option value="treatments.php"><a href="">FDA Approved Treatments</a></option>
					...
					<option value="ph2.php"><a href="">Phase 2 Vaccines</a></option>
					<option value="ph3.php"><a href="">Phase 3 Vaccines</a></option>
					<option value="ph4.php"><a href="">Phase 4 Vaccines</a></option>
				</select>
			<?php
				...
				curl_setopt_array($curl, [
					CURLOPT_URL => "https://vaccovid-coronavirus-vaccine-and-treatment-tracker.p.rapidapi.com/api/vaccines/get-all-fda-approved-treatment",
